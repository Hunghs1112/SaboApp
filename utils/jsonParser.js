// To parse this data:
//
//   const Convert = require("./jsonParser");
//
//   const apifoxModel = Convert.toApifoxModel(json);
//
...
const typeMap = {
    ...
    "Data": o([
        { json: "batchNumber", js: "batchNumber", typ: u(undefined, u(0, null)) },
        { json: "categoryId", js: "categoryId", typ: u(undefined, u(0, null)) },
        { json: "categoryName", js: "categoryName", typ: u(undefined, u(null, "")) },
        { json: "description", js: "description", typ: u(undefined, u(null, "")) },
        { json: "detailVideo", js: "detailVideo", typ: u(undefined, u(null, "")) },
        { json: "itemUrl", js: "itemUrl", typ: "" },
        { json: "mainVideo", js: "mainVideo", typ: u(undefined, u(null, "")) },
    ], "any"),
};
